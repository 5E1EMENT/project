...
// */ 
		$queryClr = "SELECT DISTINCT clr from hole, core, linkcm, mine where hole.nfileld =".$nfileld."and hole.idhole = core.idhole and core.idcore = linkcm.idcore and linkcm.idmine = mine.idmine";
